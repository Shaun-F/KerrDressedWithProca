...
calcEndingX[parameters_] :=
    4 * 10 * (parameters["m"] + parameters["n"]) / parameters["\[Mu]Nv"] ^
         2
...
qrNX =
    qrN /. rN -> xN + rplusN[\[Chi]] //
    Rationalize //
    FullSimplify;

KrNX =
    KrN /. rN -> xN + rplusN[\[Chi]] //
    Rationalize //
    FullSimplify;

\[Sigma]NX =
    \[Sigma]N /. rN -> xN + rplusN[\[Chi]] //
    Rationalize //
    FullSimplify;

\[CapitalDelta]NX =
    \[CapitalDelta]N /. rN -> xN + rplusN[\[Chi]] //
    Rationalize //
    FullSimplify;
    ...
    Block[{\[Omega]value = \[Omega]realimaglist[[1]] + I * \[Omega]realimaglist[[2]]},
        Block[{
            nuroot =Evaluate @If[TrueQ[\[Nu]fitted == Null],
                                   Evaluate @ getNuValue[\[Omega]value, parameters, ToPrecision[parameters] @ nuNNonRel[parameters]]
                                   ,
