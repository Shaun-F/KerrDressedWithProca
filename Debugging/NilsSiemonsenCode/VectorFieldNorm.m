...
complextoreal={\[Nu]->r\[Nu]+I i\[Nu],\[Omega]->\[Omega]r+I \[Omega]i,R[r[]]:> Rr[r[]]+I Ri[r[]],R'[r[]]:> Rr'[r[]]+I Ri'[r[]],S[\[Theta][]]->Sr[\[Theta][]]+I Si[\[Theta][]],S'[\[Theta][]]->Sr'[\[Theta][]]+I Si'[\[Theta][]]};

AupSimptemp=(A[b]//eval)//.complextoreal//.{t[]->t,r[]->r,\[Theta][]->\[Theta],\[Phi][]->\[Phi]};
AupSimptemp1=CoefficientList[AupSimptemp[[1]]//Re//ComplexExpand,{sin,cos}]//Simplify[#,TimeConstraint->Infinity]&; Print["t-comp. done"];
AupSimptemp2=CoefficientList[AupSimptemp[[2]]//Re//ComplexExpand,{sin,cos}]//Simplify[#,TimeConstraint->Infinity]&; Print["r-comp. done"];
AupSimptemp3=CoefficientList[AupSimptemp[[3]]//Re//ComplexExpand,{sin,cos}]//Simplify[#,TimeConstraint->Infinity]&; Print["\[Theta]-comp. done"];
AupSimptemp4=CoefficientList[AupSimptemp[[4]]//Re//ComplexExpand,{sin,cos}]//Simplify[#,TimeConstraint->Infinity]&; Print["\[Phi]-comp. done"];
...
Export["/home/shaunf/Documents/Computer/Code/projects/Massive_Vector_Field_Dynamical_Friction/ProcaAroundKerr/NilsSiemonsenCode/AupSimp.mx",AupSimp];
(*---------------------------------------------------------------------------------------------*)
...
AdownSimptemp=(A[-b]//eval)//.complextoreal//.{t[]->t,r[]->r,\[Theta][]->\[Theta],\[Phi][]->\[Phi]};
AdownSimptemp1=CoefficientList[AdownSimptemp[[1]]//Re//ComplexExpand,{sin,cos}]//Simplify[#,TimeConstraint->Infinity]&; Print["t-comp. done"];
AdownSimptemp2=CoefficientList[AdownSimptemp[[2]]//Re//ComplexExpand,{sin,cos}]//Simplify[#,TimeConstraint->Infinity]&; Print["r-comp. done"];
AdownSimptemp3=CoefficientList[AdownSimptemp[[3]]//Re//ComplexExpand,{sin,cos}]//Simplify[#,TimeConstraint->Infinity]&; Print["\[Theta]-comp. done"];
AdownSimptemp4=CoefficientList[AdownSimptemp[[4]]//Re//ComplexExpand,{sin,cos}]//Simplify[#,TimeConstraint->Infinity]&; Print["\[Phi]-comp. done"];
...
Export["/home/shaunf/Documents/Computer/Code/projects/Massive_Vector_Field_Dynamical_Friction/ProcaAroundKerr/NilsSiemonsenCode/AdownSimp.mx",AdownSimp];
...
AupSimp=Import["./AupSimp.mx"]//.coordinates//.{Global`m->Private`m,Global`\[Omega]r->Private`\[Omega]r,Global`\[Omega]i->\[Omega]i,Global`\[Chi]->Private`\[Chi],Global`r\[Nu]->Private`r\[Nu],Global`i\[Nu]->Private`i\[Nu],Global`Si->Private`Si,Global`Ri->Private`Ri,Global`Sr->Private`Sr,Global`Rr->Private`Rr}//.coordconv;
(*AdownSimp=(met[-b,-c]//eval).AupSimp//.coordinates//.coordconv/.{t->Private`t,r->Private`r,\[Theta]->Private`\[Theta],\[Phi]->Private`\[Phi]};*)
AdownSimp=Import["./AdownSimp.mx"]//.coordinates//.{Global`m->Private`m,Global`\[Omega]r->Private`\[Omega]r,Global`\[Omega]i->\[Omega]i,Global`\[Chi]->Private`\[Chi],Global`r\[Nu]->Private`r\[Nu],Global`i\[Nu]->Private`i\[Nu],Global`Si->Private`Si,Global`Ri->Private`Ri,Global`Sr->Private`Sr,Global`Rr->Private`Rr}//.coordconv;
...
Export["/home/shaunf/Documents/Computer/Code/projects/Massive_Vector_Field_Dynamical_Friction/ProcaAroundKerr/NilsSiemonsenCode/Tdd.mx",Tdd];
...
Tdd=Import["./Tdd.mx"]//.coordinates//.{Global`m->Private`m,Global`\[Omega]r->Private`\[Omega]r,Global`\[Omega]i->\[Omega]i,Global`\[Chi]->Private`\[Chi],Global`r\[Nu]->Private`r\[Nu],Global`i\[Nu]->Private`i\[Nu],Global`Si->Private`Si,Global`Ri->Private`Ri,Global`Sr->Private`Sr,Global`Rr->Private`Rr}//.coordconv;
...
Export["./Tud.mx",Tud];
Tud=Import["./Tud.mx"]//.coordinates//.{Global`m->Private`m,Global`\[Omega]r->Private`\[Omega]r,Global`\[Omega]i->\[Omega]i,Global`\[Chi]->Private`\[Chi],Global`r\[Nu]->Private`r\[Nu],Global`i\[Nu]->Private`i\[Nu],Global`Si->Private`Si,Global`Ri->Private`Ri,Global`Sr->Private`Sr,Global`Rr->Private`Rr}//.coordconv;
...
coefflistup=DeleteCases[CoefficientList[AupSimp[[i]]/.{\[Omega]i->0},{sin,cos}]/.{\[Nu]i->i\[Nu],\[Nu]r->r\[Nu]}/.{\[Chi]->\[Chi]0,m->m0,r\[Nu]->r\[Nu]0,i\[Nu]->i\[Nu]0,\[Omega]r->\[Omega]r0,\[Mu]->\[Mu]0,nh->nh0},0,2]//Flatten;
	...
	coefflistdownExpl[[ir,i\[Theta],1]]=prec@(coefflistdown[[1]]//.solidentify//.{r->rinput}//.{\[Theta]->\[Theta]input}); (*cos part*)
	coefflistupExpl[[ir,i\[Theta],1]]=prec@(coefflistup[[1]]//.solidentify//.{r->rinput}//.{\[Theta]->\[Theta]input}); (*cos part*)
	coefflistdownExpl[[ir,i\[Theta],2]]=prec@(coefflistdown[[2]]//.solidentify//.{r->rinput}//.{\[Theta]->\[Theta]input}); (*sin part*)
	coefflistupExpl[[ir,i\[Theta],2]]=prec@(coefflistup[[2]]//.solidentify//.{r->rinput}//.{\[Theta]->\[Theta]input}); (*sin part*)
...
Adownvector[tt1_,rr1_,\[Theta]\[Theta]1_,\[Phi]\[Phi]1_]:=AdownSimpExpl//.parameters//.{t->tt1,r->rr1,\[Theta]->\[Theta]\[Theta]1,\[Phi]->\[Phi]\[Phi]1};
Aupvector[tt2_,rr2_,\[Theta]\[Theta]2_,\[Phi]\[Phi]2_]:=AupSimpExpl//.parameters//.{t->tt2,r->rr2,\[Theta]->\[Theta]\[Theta]2,\[Phi]->\[Phi]\[Phi]2};
