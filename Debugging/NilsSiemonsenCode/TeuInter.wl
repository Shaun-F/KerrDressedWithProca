...
modedataoutput=prec@Import[FileNameJoin[{NotebookDirectory[],ToString["precision_mode_library/m"<>ToString[m]<>ToString["n"]<>ToString[n]<>ToString["_a"]<>ToString[spinstring]<>ToString["_Sm1_prec_p_HPee.mx"]]}]]//.{QNMcode`r\[Nu]->r\[Nu],QNMcode`i\[Nu]->i\[Nu],QNMcode`\[Theta]->\[Theta],QNMcode`R->R}//.{QNMmode`r\[Nu]->r\[Nu],QNMmode`i\[Nu]->i\[Nu],QNMmode`\[Theta]->\[Theta],QNMmode`R->R};
