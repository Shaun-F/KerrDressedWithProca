...
ProcaSolution=DeleteCases[Import["./precision_mode_library/m"<>ToString[min]<>ToString["n"]<>ToString[nin]<>ToString["_a"]<>ToString[spinstring]<>If[min==1,ToString["_Sm1_prec.mx"],ToString["_Sm1_prec_overT.mx"]]]//.variableconversion,0,3];
