...
QNMnonRel[min_,nin_,spin_,\[Mu]sta_,\[Mu]sto_,branch1_,\[Omega]ImIn_,Sin_,direc_]:=Module[{min1=min,nin1=nin,spin1=spin,\[Mu]sta1=\[Mu]sta,\[Mu]sto1=\[Mu]sto,branch2=branch1,wijk=\[Omega]ImIn,Sin1=Sin},

destinationPATH=ToString["../surrogate"];
$Assumptions=M>0&&x!=0;
kmax=5;
xmax=2;
\[Epsilon]=10^-6;
...
Export[ToString[ToString[destinationPATH]<>"/m"<>ToString[m]<>ToString["n"]<>ToString[nh]<>ToString["_a"]<>ToString[spinstring]<>ToString["_S"]<>ToString[If[Sin<0,"m","p"]]<>ToString[Abs[Sin]]<>ToString["_prec_"]<>ToString[If[direc<1,"m","p"]]<>ToString["_HPee.mx"]],modedataoutput];
