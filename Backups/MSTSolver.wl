...
RenormedAngularMomentum[\[Omega]_,\[Chi]_,m_,l_,s_]:=
Block[{RenormedAngularMomentumtmp,nsample=0},
...
testval = RenormalizedAngularMomentum[s,l,m,\[Chi],\[Omega], Method->{"Monodromy", "nmax"->$RAMMaxN}]//ToPrecision;
...
Solution = {r}|->Evaluate[Normalization*RSolution[r]];
Return[<|"Solution"->Solution, "BCs"->InitialConditions, "FrobeniusSolution"->FrobSolution|>];
]
]
